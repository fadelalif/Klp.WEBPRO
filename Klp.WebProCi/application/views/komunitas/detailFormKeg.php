                    ...
                    <form action="<?php echo site_url('Kegiatan/detailkeg/' . $kegiatan->id); ?>" method="post" enctype="multipart/form-data" role="form">
                        ...
                        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
                            <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control" placeholder="Nama Keigatan" aria-label="Nama Keigatan"
                                aria-describedby="basic-addon1" value="<?php echo $kegiatan->nama_kegiatan; ?>" disabled/>
                        </div>
                        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
                            <input type="text" name="aktivitas_kegiatan" id="aktivitas_kegiatan" class="form-control" placeholder="aktivitas" aria-label="aktivitas"
                                aria-describedby="basic-addon1" value="<?php echo $kegiatan->aktivitas_kegiatan; ?>" disabled/>
                        </div>
                        <h2 class="AkunHead fw-semibold " style="margin-left: 465px;">
                            Data Keigatan
                        </h2>
                        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
                            ...
                            <input type="date" class="form-control" id="tanggal_kegiatan" name="tanggal_kegiatan"
                                aria-describedby="basic-addon1" value="<?php echo $tanggal_kegiatan_value; ?>" autocomplete="off" disabled/>
                        </div>
                        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
                            <input type="text" name="lokasi_kegiatan" id="lokasi_kegiatan" class="form-control" placeholder="Lokasi Kegiatan"
                                aria-label="Lokasi Kegiatan" aria-describedby="basic-addon1" value="<?php echo $kegiatan->lokasi_kegiatan; ?>" disabled/>
                        </div>
                        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
                            <input type="text" name="penanggung_jawab" id="penanggung_jawab" class="form-control" placeholder="Penanggung Jawab" aria-label="Penanggung Jawab"
                                aria-describedby="basic-addon1" value="<?php echo $kegiatan->penanggung_jawab; ?>" disabled/>
                        </div>
                        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
                        ...
                        <textarea class="form-control" name="deskripsi_kegiatan"placeholder="Masukan Deskripsi Kegiatan Anda" id="desc" style="height: 100px" disabled><?php echo $kegiatan->deskripsi_kegiatan; ?></textarea>
                        <label for="desc">Deskripsi</label>
                        </div>
                        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
                            <label class="input-group-text" for="provinsi">Provinsi</label>
                            <select class="form-select" id="provinsi" name="provinsi" aria-describedby="basic-addon1" disabled>
                        ...
                        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
                            <input type="file" name="fileUpload" size="20" disabled/>
                        </div>
