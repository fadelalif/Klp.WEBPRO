    ...
    <div class="container-fluid">
      ...
      <div class="row" style="padding:20px 122px; ">
        <div class="col-md-12" style="background-color:#DADADA;">
          <h2 style="padding-top:19px">Oleh <span style="color: #00897B; font-weight: 700;">Cahaya Daun</h2>
          <h3 style="padding-top:37px;">Deskripsi</h3>
          <h4 style="width: 100%;">Komunitas cahaya bumi membuka pendaftaran bagi anda yang berada di daerah Bandung dan
            ...
            lain untuk menggantikan plastik.</h4>
          <h3 style="padding-top:37px;">Aktivitas</h3>
          <h4 style="width: 100%;">Volunteers diharapkan mampu menjaga kebersihan dan penggerak aksi zero waste pada
            lingkungan sekitar.</h4>
