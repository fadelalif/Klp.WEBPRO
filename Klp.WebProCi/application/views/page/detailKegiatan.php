    ...
    <div class="row w-auto h-auto pb-5 pt-5">
      <div class="col-md-8 pe-2 mt-5">
        <div class="img-fluid mt-5 text-center pt-5">
          <img src="<?= base_url() ?>uploads/<?= isset($kegiatan->uploadFile) ? $kegiatan->uploadFile : '' ?>"
            class="img-fluid rounded-4" style="max-width: 800px;" alt="Foto_Content" />
        </div>
      ...
      <div class="col-6 col-md-4 h-min mt-5 pt-5 pe-5 ">
        <div class="card border-white shadow p-3 mb-5 bg-body-tertiary rounded-4 bg-white mt-4 ">
          ...
          <p><i class="fa-solid fa-calendar-days" style="color: #00897b; margin-right:10px;"></i>
            <?= $kegiatan->tanggal_kegiatan ?>
          </p>
          <p><i class="fa-solid fa-location-dot" style="color: #00897b; margin-right:10px;"></i>
