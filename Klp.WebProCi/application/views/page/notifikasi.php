...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/styleNotifikasi.css">
...
<body>
    ...
    <section id="navProfil">
        <nav class="nav navProf nav-pills nav-fill container-expand " style="padding-top:99px;">
            ...
            <a class="nav-item nav-link navProfButt active" href="<?= base_url() ?>index.php/Notifikasi">
    ...
    <section id="Notifikasi" style="padding-top: 10px; padding-bottom:10px;">
        <div class="container-fluid ">
            <div class="row" style="padding:20px 122px;">
                <div class="col-md-12 ">
                    <h2 style="padding-left:10px;">Notifikasi</h2>
                    <h3 style="padding-left:10px;">Semua pesan dan pemberitahuan akan berada disini!</h3>
                    <table class="table">
                        <thead class="table-light"">
                            <tr>
                            <th class="isiHead"scope="col" style="background-color: #00897b; color: #fff; border-radius: 10px 10px 0px 0px;">Notifikasi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
