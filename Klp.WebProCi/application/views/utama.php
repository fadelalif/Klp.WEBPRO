  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg position-fixed w-100">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="assets/img/relawain logo 1.png" alt="" />
        </a>
        <button
    ...
    <section id="hero">
      <div class="container h-100">
        <div class="row h-100">
          <div class="col-md-3 hero-tagline my-auto">
            ...
            <div class="button-container">
              <button class="download-button1">
                <img src="assets/img/ios-android 1.jpg" alt="" style="width: 200px; border-radius:8%"/>
              </button>
              <button class="download-button2">
                <img src="assets/img/ios-android 2.jpg" alt="" style="width: 200px; border-radius:8%"/>
              </button>
            </div>
          </div>
        </div>
    ...
    <footer id="footer" class="text-center text-lg-start" >
      <!-- Section: Links  -->
      <section class="container p-1" id="contact-us">
        <div class="container text-center text-md-start mt-5">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              <!-- Content -->
              <a>
                <img src="assets/img/icon logo 1.png" alt="" />
              </a>
            </div>
            <!-- Grid column -->
