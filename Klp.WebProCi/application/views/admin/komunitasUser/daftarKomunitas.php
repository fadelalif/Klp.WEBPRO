                ...
                <tbody>
                    ...
                    foreach ($data as $row):?>
                        <tr>
                            ...
                            <!-- <td><?= $row->password ?></td> -->
                            <td>
                                <button class="button" onclick="location.href='<?php echo site_url('DaftarRelawan/view/' . $row->id); ?>'"><i class="fas fa-eye"></i></button>
                ...
                <tbody>
                    ...
                    foreach ($data as $row):?>
                        <tr>
                            ...
                            <!-- <td><?= $row->password ?></td> -->
                            <td>
                                <button class="button" onclick="location.href='<?php echo site_url('DaftarRelawan/view/' . $row->id); ?>'"><i class="fas fa-check"></i></button>
                                <button class="buttonDel" onclick="hapusData('<?= site_url('DaftarKomunitas/hapus/' . $row->id); ?>')"><i class="fas fa-x"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
